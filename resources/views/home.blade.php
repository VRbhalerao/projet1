    ...
    <div class="container">
        <div class="">
            <div class="row">
                <div class="col-12 tm-site-header-col">
                    <div class="tm-site-header-right">
                        <i class="far fa-2x fa-eye tm-site-icon"></i>
                        <p class="font-weight-bold">My Vision</p>
                        <h1 class="tm-site-name"><i>Welcome to Udaan</i></h1>
                    </div>
                        ...
                        <nav class="navbar navbar-expand-md">
                          ...
                          <div class="collapse navbar-collapse tm-nav" id="navbarSupportedContent1">
                            ...
                            <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                <a class="nav-link tm-nav-link" href="company.html">Company</a>
                              </li>
                              <li class="nav-item">
        ...
        <main>
            ...
            <section class="tm-welcome">
                <div class="row">
                    <div class="col-12">
                        <h2 class="tm-section-header tm-header-floating"><i>Welcome to Udaan</i></h2> 
                ...
                <div class="row tm-welcome-row-2">
                    ...
                    <div class="col-lg-4 tm-dotted-box-container">
                        <article class="tm-dotted-box">
                            ...
                            <h3 class="tm-article-title">My Vision</h3>
            ...
            <section class="tm-featured">
                <div class="row">
                    <div class="col-12">
                        <h2 class="tm-section-header tm-section-header-small"><i>Featured Carousel Items<i></h2>        
                    </div>
                </div>
            ...
            <footer>
                Copyright &copy; 2023 welcome to Udaan
